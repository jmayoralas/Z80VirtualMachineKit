...
extension Z80 {
    func initOpcodeTableCB(inout opcodes: OpcodeTable) {
        ...
        opcodes[0x46] = { // BIT 0,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 0, ulaOp: .Bit, ignoreCarry: false)
        }
        ...
        opcodes[0x4E] = { // BIT 1,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 1, ulaOp: .Bit, ignoreCarry: false)
        }
        ...
        opcodes[0x56] = { // BIT 2,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 2, ulaOp: .Bit, ignoreCarry: false)
        }
        ...
        opcodes[0x5E] = { // BIT 3,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 3, ulaOp: .Bit, ignoreCarry: false)
        }
        ...
        opcodes[0x66] = { // BIT 4,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 4, ulaOp: .Bit, ignoreCarry: false)
        }
        ...
        opcodes[0x6E] = { // BIT 5,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 5, ulaOp: .Bit, ignoreCarry: false)
        }
        ...
        opcodes[0x76] = { // BIT 6,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 6, ulaOp: .Bit, ignoreCarry: false)
        }
        ...
        opcodes[0x7E] = { // BIT 7,(HL)
            self.t_cycle += 4
            self.ulaCall(self.dataBus.read(self.regs.hl), 7, ulaOp: .Bit, ignoreCarry: false)
        }
