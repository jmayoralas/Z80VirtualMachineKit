...
- (nullable instancetype)initFromAVAudioFile:(AVAudioFile * _Nonnull)avAudioFile error:(NSError * _Nullable * _Nullable)error;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull commonFormatAsString;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull fileFormatSettings;
@property (nonatomic, readonly, copy) NSDictionary<NSString *, id> * _Nonnull processingFormatSettings;
@property (nonatomic, readonly) NSURL * _Nonnull directoryPath;
@property (nonatomic, readonly, copy) NSString * _Nonnull fileNameWithExtension;
...
@protocol AKAudioPlayerDelegate;
...
*/
@property (nonatomic, weak) id <AKAudioPlayerDelegate> _Nullable delegate;
/**
...
@property (nonatomic, readonly, strong) AKAudioFile * _Nonnull akAudioFile;
/**
...
*/
- (nullable instancetype)initWithAKAudioFile:(AKAudioFile * _Nonnull)file error:(NSError * _Nullable * _Nullable)error completionHandler:(void (^ _Nullable)(void))completionHandler OBJC_DESIGNATED_INITIALIZER;
/**
  To stay compatible with ealier version
  Should be deprecated because you cannot handle errors at run time…
  :-/
*/
- (nonnull instancetype)init:(NSString * _Nonnull)file completionHandler:(void (^ _Nullable)(void))completionHandler;
- (void)start;
/**
  Stop playback
*/
...
*/
- (void)replaceAKAudioFile:(AKAudioFile * _Nonnull)newAKAudioFile;
/**
  To stay compatible with ealier version
...
SWIFT_PROTOCOL("_TtP8AudioKit21AKAudioPlayerDelegate_")
@protocol AKAudioPlayerDelegate
@optional
- (void)playerStoppedOrFinished;
- (void)playHeadSnapshot:(double)playHead;
@end
...
/**
  ...
  \param note MIDI Note being started
...
/**
  ...
  \param note MIDI Note being stopped
...
*/
- (nonnull instancetype)initWithName:(NSString * _Nonnull)name deviceID:(AudioDeviceID)deviceID OBJC_DESIGNATED_INITIALIZER;
/**
...
/**
  ...
  AKView
*/
+ (NSView * _Nonnull)createView:(CGFloat)width height:(CGFloat)height;
@end
...
*/
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) AVAudioFormat * _Nonnull format;)
